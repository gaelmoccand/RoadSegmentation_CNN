...
class TrainModel(object):
    ...
    def train(self, mode='segnet_connected', epochs=5, learning_rate_init=0.001, checkpoint='', batch_size=20, l2_reg=0.0001, nclass=2, do_resize=False):
